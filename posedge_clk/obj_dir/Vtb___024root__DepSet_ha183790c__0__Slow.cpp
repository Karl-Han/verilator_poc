...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    vlSelf->tb__DOT__SelectTest = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__Validate = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__counter_global = VL_RAND_RESET_I(32);
    vlSelf->tb__DOT__do_something_here_SelectTest__Vstatic__fd1 = 0;
    vlSelf->tb__DOT__do_something_here_Validate__Vstatic__i = 0;
    vlSelf->tb__DOT__do_something_here_Validate__Vstatic__fd = 0;
