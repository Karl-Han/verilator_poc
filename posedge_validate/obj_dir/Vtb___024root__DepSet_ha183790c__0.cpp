...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__1__PROF__performance_degrade__l65(Vtb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb___024root___nba_sequent__TOP__1__PROF__performance_degrade__l65\n"); );
    // Init
...
void Vtb___024root___eval_nba(Vtb___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtb___024root___nba_sequent__TOP__1__PROF__performance_degrade__l65(vlSelf);
    }
}
